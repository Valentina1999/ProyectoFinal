...
namespace Web.Presentacion.Master {
    ...
    public partial class DataLogin : global::System.Data.DataSet {
        ...
        public partial class UsuarioDataTable : global::System.Data.TypedTableBase<UsuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UsuarioRow AddUsuarioRow(string Documento, string Nombre, string Apellido, string Correo, string Clave, string Numero, int IdRol) {
...
namespace Web.Presentacion.Master.DataLoginTableAdapters {
    ...
    public partial class UsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuario] ([Documento], [Nombre], [Apellido], [Correo], [Clave]" +
                ", [Numero], [IdRol]) VALUES (@Documento, @Nombre, @Apellido, @Correo, @Clave, @N" +
                "umero, @IdRol)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Usuario] SET [Documento] = @Documento, [Nombre] = @Nombre, [Apellid" +
                "o] = @Apellido, [Correo] = @Correo, [Clave] = @Clave, [Numero] = @Numero, [IdRol" +
                "] = @IdRol WHERE (([IdUsuario] = @Original_IdUsuario))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["SGCPA2ConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IdUsuario, Documento, Nombre, Apellido, Correo, Clave, Numero, IdRol FROM " +
                "dbo.Usuario";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Correo FROM Usuario where Correo = @correo and Clave = @clave";
        ...
        public virtual int Fill(DataLogin.UsuarioDataTable dataTable) {
        ...
        public virtual DataLogin.UsuarioDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataLogin.UsuarioDataTable dataTable = new DataLogin.UsuarioDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataLogin.UsuarioDataTable dataTable) {
        ...
        public virtual int Insert(string Documento, string Nombre, string Apellido, string Correo, string Clave, string Numero, int IdRol) {
            if ((Documento == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[6].Value = ((int)(IdRol));
        ...
        public virtual int Update(string Documento, string Nombre, string Apellido, string Correo, string Clave, string Numero, int IdRol, int Original_IdUsuario) {
            if ((Documento == null)) {
                throw new global::System.ArgumentNullException("Documento");
            }
            else {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual string Login(string correo, string clave) {
